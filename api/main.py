...
# Definimos las rutas relativas que vamos a usar
ruta_modelo = os.path.join("modelo", "modelo_recomendacion_pca.pkl")
ruta_titulos = os.path.join("modelo", "titulos.pkl")
ruta_pca = os.path.join("modelo", "pca_model.pkl")
ruta_datos = os.path.join("datos", "data_peliculas.csv")
ruta_datos_reducido = os.path.join("datos", "data_peliculas_reducido.csv")
